...
public class SpriteBitmapArray extends Sprite
{
   ...
   public void paint(Graphics g)
   {
      ...
      {
         if (mode==SEQUENCE) {
           g.drawImage(images[sequence[currentImage]], (int)getX(), (int)getY(), component);
         } else if (images.length > 0) {
            g.drawImage(images[currentImage], (int)getX(), (int)getY(), component);
         }
      }
   }
    ...
    @Override
    public int getWidth() {
        return images[currentImage].getWidth(component);
    }

    @Override
    public int getHeight() {
        return images[currentImage].getHeight(component);
    }
}
